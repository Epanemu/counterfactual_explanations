...
if dataset == 'FICO':
    ...
    input_data = frame[frame.columns[1:]]
else:
    # Adult dataset
    # load dataset
...
# If dataset is 'Fico' exp.string_vals is already correctly set up.
...
#   string_vals={-9.0:",i.e. No Bureau Record or No Investigation,",
...
text = exp.explain_datapoint(input_data.iloc[i].values, n)
...
explanations = exp.explain_datapoint_better(input_data.iloc[i].values, n)
